...
the [API docs](https://doc.deno.land/https://garn.io/ts/v0.0.16/mod.ts) as well.

## Environments

(See also the [API docs](https://doc.deno.land/https://garn.io/ts/v0.0.16/mod.ts/~/Environment).)
...
(See also the [API docs](https://doc.deno.land/https://garn.io/ts/v0.0.16/mod.ts/~/Check).)
...
(See also the [API docs](https://doc.deno.land/https://garn.io/ts/v0.0.16/mod.ts/~/Executable).)
...
where you'd like to receive them. For example:

```typescript
import * as garn from "https://garn.io/ts/v0.0.16/mod.ts";

export const hello =
  garn.shell('printf "My first two arguments were %s and %s" "$@"');
```

This works exactly like bash-script arguments. For the exact behavior, see `man bash`, section `PARAMETERS`.
...
(See also the [API docs](https://doc.deno.land/https://garn.io/ts/v0.0.16/mod.ts/~/Project).)
